...
const DOM = {
    ...
    updateBalance(){
        document
            ...
            .innerHTML = Utils.fomartCurrency(Transaction.incomes())
        
        document
            .getElementById('expenseDisplay')
            .innerHTML = Utils.fomartCurrency(Transaction.expenses())
        
        document
            .getElementById('totalDisplay')
            .innerHTML = Utils.fomartCurrency(Transaction.total())
    },
...
const Form = {
    ...
    validateFiled(){
        ...
        if (description.trim() === "" || amount.trim() === "" || date.trim() === ""){
            throw new Error("Por favor, preencha todas os campos.")
        }
    },
